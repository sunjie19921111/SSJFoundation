//
//  PL_ProvidenceIndentTextField.h
//  kkcoin
//
//  //
//
...
@class PL_ProvidenceIndentTextField;


/* 文本框结束编辑的block */
typedef void(^TextFieldDidEndEditingBlock)(PL_ProvidenceIndentTextField *field , NSDictionary *info);

/* 文本框超出文字个数限制的block */
typedef void(^TextFieldDidMoreThanLengthLimitBlock)(PL_ProvidenceIndentTextField *field, NSInteger limit);
/* 文字已经改变的block */
typedef void(^TextDidChangeBlocke)(PL_ProvidenceIndentTextField *field , NSDictionary *info);

/* 文本框开始编辑的block */
typedef void(^TextFieldBeginEditingBlock)(PL_ProvidenceIndentTextField *field , NSDictionary *info);
...
/** 输入框开始编辑的回调
 ...
 @param info 其他信息
 */
- (void)textField:(PL_ProvidenceIndentTextField *)textField textDidBeginEditingWithUserInfo:(NSDictionary * _Nullable)info;
...
/**
 ...
 @param info 其他信息
 */
- (void)textField:(PL_ProvidenceIndentTextField *)textField textDidEndEditingWithUserInfo:(NSDictionary * _Nullable)info;
/**
 输入框文字改变的回调
...
@interface PL_ProvidenceIndentTextField : UITextField
...
/**
 代理
 */
@property (weak, nonatomic) id<UITextFieldOtherProtocol> PL_ProvidenceIndentTextFieldDelegate;
