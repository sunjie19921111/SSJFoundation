...
@interface PL_ProvidenceBaseButton()

/** buttonConifig */
@property (nonatomic, strong) PL_ProvidenceBaseButtonConfig *buttonConfig;

@end

@implementation PL_ProvidenceBaseButton
