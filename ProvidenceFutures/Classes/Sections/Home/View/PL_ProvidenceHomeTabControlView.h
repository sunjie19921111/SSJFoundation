//
//  PL_ProvidenceHomeTabControlView.h
//  kkcoin
//
//  //
//
...
@class PL_ProvidenceHomeTabControlView;
@protocol PL_ProvidenceMainTabControlViewProtocol <NSObject>
@optional
/**
 点击了选项的回调

 @param PL_ProvidenceHomeTabControlView 选项卡视图
 @param item 被点击的选项按钮
...
/**
 ...
 @return 自定义后的按钮视图
 */
- (UIButton * _Nullable)tabContolView:(PL_ProvidenceHomeTabControlView *)PL_ProvidenceHomeTabControlView willCreateItemAtIndex:(NSInteger)index title:(NSString *)title;

@end

/** 选项卡视图封装 */

@interface PL_ProvidenceHomeTabControlView : UIView

/**
 代理
 */
@property (weak, nonatomic) id<PL_ProvidenceMainTabControlViewProtocol> delegate;
